...
const EarthLoader: React.FC = () => {
  return (
    <div className="earth flex flex-col items-center justify-center h-screen">
      <div className="earth-loader relative w-40 h-40 flex justify-center items-center">
        {[
          ...
          >
            <path transform="translate(100 100)" d={d} fill="#7CC133" />
          </svg>
        ))}
      </div>
